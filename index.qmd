...
One of the tasks of a more recent Center of Excellence on SDC, as part of the STACE project (grant agreement 899218--2019-BG-Methodology, 2020--2024), was to update the handbook. With permission of all the original authors, the current updated version was produced by the partnerss in the STACE project. The format of the handbook was revised to facilitate online as well as offline publication and some new content was added.

However, the authors still see this version of the handbook as a "live" document that could be updated from time to time. Therefore we will appreciate your comments and suggestiosn for improvements. Please submit your comments or suggestions to the Issues page of the [[User Support repository on https://github.com/sdctools]{.underline}](https://github.com/sdctools/UserSupport).
...
*Risk and Utility*\
NSIs should aim to determine optimal SDC methods and solutions that minimize disclosure risk while maximizing the utility of the data. @fig-R-U-map contains an R-U confidentiality map developed by Duncan, et. al. (2001) where R is a quantitative measure of disclosure risk and U is a quantitative measure of data utility.
