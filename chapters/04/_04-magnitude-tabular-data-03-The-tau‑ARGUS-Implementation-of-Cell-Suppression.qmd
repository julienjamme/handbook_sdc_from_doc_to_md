## The $\tau$‑ARGUS Implementation of Cell Suppression: Methodological Background, Guidance and Recommendations {#sec-tau-argus-suppression}
...
### Processing table protection efficiently {#sec-efficient-protection-process} <!-- .Opmaakprofiel-Kop-3-+-Na:--3-pt} -->
...
### Introductive Example {#sec-introductive-example} <!-- .Opmaakprofiel-Kop-3-+-Na:--3-pt} -->
