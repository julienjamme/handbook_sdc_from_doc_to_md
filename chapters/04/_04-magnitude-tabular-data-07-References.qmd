...
Castro, J.(2002), *Network flows heuristics for complementary \index{cell suppression}: an empirical evaluation and extensions*, in LNCS 2316, Inference Control in Statistical Databases, J. Domingo-Ferrer (Ed), (2002) 59--73
...
Wolf, P.P. de (2002). *HiTaS: a heuristic approach to \index{cell suppression} in hierarchical tables.* Proceedings of the AMRADS meeting in Luxembourg.
