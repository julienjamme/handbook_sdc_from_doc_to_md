...
For more information about the `ptable` package, please see the vignette or the reference manual on CRAN ([[https://cran.r-project.org/web/packages/ptable]{.underline}](https://cran.r-project.org/web/packages/ptable)). 
...
For information how to use the software, we refer to the vignettes of the respective R-packages on CRAN ([[https://cran.r-project.org/]{.underline}](https://cran.r-project.org/)) and to the manual of  $\tau$-ARGUS and to the quick references for CKM in $\tau$‑ARGUS on GitHub ([https://github.com/sdcTools/tauargus/releases]{.underline}(https://github.com/sdcTools/tauargus/releases)).
