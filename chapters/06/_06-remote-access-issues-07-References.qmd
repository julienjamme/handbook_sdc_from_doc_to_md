...
Brandt, M. et al. (2009). *Guidelines for the checking of output based on microdata research:* [[https://research.cbs.nl/casc/ESSnet/GuidelinesForOutputChecking_Dec2009.pdf]{.underline}](https://research.cbs.nl/casc/ESSnet/GuidelinesForOutputChecking_Dec2009.pdf)

The DwB project, Work Package 11, extracted from the deliverable D11.8 (2015). *Guidelines for Output Checking:* [[https://cros.ec.europa.eu/system/files/2024-02/Output-checking-guidelines.pdf]{.underline}](https://cros.ec.europa.eu/system/files/2024-02/Output-checking-guidelines.pdf)
